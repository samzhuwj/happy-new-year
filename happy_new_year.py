...
number8 = [[8,0],[8,4]]
number9 = [[9,0],[9,4]]
number10= [[10,0],[10,1],[10,2],[10,3],[10,4]]
#7
number12 = [[12,1],[12,2]]
number13 = [[13,2]]
number14 = [[14,2]]
number15 = [[15,2]]
number16 = [[16,1],[16,2],[16,3]]

#11
number18 = [[18,1],[18,2],[18,3]]
number19 = [[19,0],[19,4]]
number20 = [[20,1],[20,2],[20,3]]
number21 = [[21,0],[21,4]]
number22 = [[22,1],[22,2],[22,3]]
...
def number(lx,ly,y,char):
    ...
    for x in range(0,5,1):
        window.addstr((lx+number4[x][0]), (ly+number4[x][1]), char, curses.color_pair(y))
    for x in range(0,5,1):
        window.addstr((lx+number6[x][0]), (ly+number6[x][1]), char, curses.color_pair(y))
    for x in range(0,2,1):
        window.addstr((lx+number7[x][0]), (ly+number7[x][1]), char, curses.color_pair(y))
    for x in range(0,2,1):
        window.addstr((lx+number8[x][0]), (ly+number8[x][1]), char, curses.color_pair(y))
    for x in range(0,2,1):
        window.addstr((lx+number9[x][0]), (ly+number9[x][1]), char, curses.color_pair(y))
    for x in range(0,5,1):
        window.addstr((lx+number10[x][0]), (ly+number10[x][1]), char, curses.color_pair(y))
    for x in range(0,2,1):
        window.addstr((lx+number12[x][0]), (ly+number12[x][1]), char, curses.color_pair(y))
    for x in range(0,1,1):
        window.addstr((lx+number13[x][0]), (ly+number13[x][1]), char, curses.color_pair(y))
    for x in range(0,1,1):
        window.addstr((lx+number14[x][0]), (ly+number14[x][1]), char, curses.color_pair(y))
    for x in range(0,1,1):
        window.addstr((lx+number15[x][0]), (ly+number15[x][1]), char, curses.color_pair(y))
    for x in range(0,3,1):
        window.addstr((lx+number16[x][0]), (ly+number16[x][1]), char, curses.color_pair(y))
    for x in range(0,3,1):
        window.addstr((lx+number18[x][0]), (ly+number18[x][1]), char, curses.color_pair(y))
    for x in range(0,2,1):
        window.addstr((lx+number19[x][0]), (ly+number19[x][1]), char, curses.color_pair(y))
    for x in range(0,3,1):
        window.addstr((lx+number20[x][0]), (ly+number20[x][1]), char, curses.color_pair(y))
    for x in range(0,2,1):
        window.addstr((lx+number21[x][0]), (ly+number21[x][1]), char, curses.color_pair(y))
    for x in range(0,3,1):
        window.addstr((lx+number22[x][0]), (ly+number22[x][1]), char, curses.color_pair(y))
